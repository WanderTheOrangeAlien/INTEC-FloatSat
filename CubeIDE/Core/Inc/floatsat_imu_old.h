 ...
 */
FS_IMU_Status_t FS_IMU_Detect(I2C_HandleTypeDef *hi2c, FS_IMU_Info_t *info);

/**
 * @brief Detecta y configura acelerómetro, giroscopio y magnetómetro.
 */
FS_IMU_Status_t FS_IMU_Init(I2C_HandleTypeDef *hi2c, FS_IMU_Info_t *info);
